...
(function($) {
	...
	var defaults = {
		...
		classes: {
			months: {
				...
				Sábado: 'cal-day-weekend',
				Domingo: 'cal-day-weekend',
	...
	var defaults_extended = {
		...
		holidays: {
			...
			// Third (+3*) Segunda (1) in janeiro (01)
			'01+3*1': "Birthday of Dr. Martin Luther King, Jr.",
			// Third (+3*) Segunda (1) in Fevereiro (02)
			'02+3*1': "Washington's Birthday",
			// Last (-1*) Segunda (1) in Maio (05)
			'05-1*1': "Memorial Day",
			// Julho 4
			'04-07': "Independence Day",
			// First (+1*) Segunda (1) in Setembro (09)
			'09+1*1': "Labor Day",
			// Second (+2*) Segunda (1) in Outubro (10)
			'10+2*1': "Columbus Day",
			// Novembro 11
			'11-11': "Veterans Day",
			// Fourth (+4*) Quinta (4) in Novembro (11)
	...
	Calendar.prototype._getDayClass = function(class_group, date) {
		...
		switch(date.getDay()) {
			case 0:
				addClass("Domingo", classes);
				break;
			case 6:
				addClass("Sábado", classes);
				break;
		}
